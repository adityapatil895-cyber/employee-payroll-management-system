...
public class PdfService {
    ...
    public void generatePayslip(Employee employee, HttpServletResponse response) throws IOException {
        ...
        response.setHeader("Content-Disposition",
                "attachment; filename=payslip_" + employee.getName() + ".pdf");
        ...
        PdfPCell subCell = new PdfPCell(new Phrase("Monthly Payslip", new Font(Font.HELVETICA, 12, Font.NORMAL, Color.WHITE)));
